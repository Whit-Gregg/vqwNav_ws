#/home/whit/vqwNav_ws/src/vqwbot_nav_bringup/launch/slam_toolbox_online_async_launch.py
...
def generate_launch_description():
    ...
    declare_slam_params_file_cmd = DeclareLaunchArgument(
        'slam_params_file',
        default_value=os.path.join(get_package_share_directory('vqwbot_nav_bringup'),
                                   'params', 'slam_toolbox_mapper_params_lifelong.yaml'),
